...
function NavBar({ session, loggedIn, user, searchQ = '' }) {
    ...
    const pages = [
        ...
        { name: 'Facilities', link: '/facilities', protected: true, allowedGroups: [1,2,3,4,5,6,7,10,11,12] },
        { name: 'Community Units', link: '/public/community-units' },
        { name: 'Community Units', link: '/community-units', protected: true, allowedGroups: [1,2,3,4,5,6,7,10,11,12] },
        { name: 'Users', link: '/users', protected: true, allowedGroups: [1,3,5,10] },
        { name: 'System setup', link: '/system_setup', protected: true, allowedGroups: [1,3,5,10] },
        { name: 'Reports', link: '/reports', protected: true, allowedGroups: [1,2,3,4,5,6,7,10,11,12] },
