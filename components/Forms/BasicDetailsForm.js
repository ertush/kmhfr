...
export function BasicDeatilsForm({ editMode }) {
  ...
  if (isClient) {
    return (
      <>
        {/* loading */}
        {submitting && <div style={{inset: 0, zIndex: 999, display: 'block', position: 'fixed', left: '48%', top: '8em'}}>
          <div className='w-12 h-12 border-l-2 border-t-4 border-blue-700 shadow rounded-full animate-spin'></div>
        </div>}
