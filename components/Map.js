...
const Map = ({ operational, lat, long, name, code }) => {
    return (
        <MapContainer center={[-0.818389, 37.477222]} zoom={6.499} maxZoom={15.70} scrollWheelZoom={false} touchZoom={false} style={{ height: 650, width: "100%", position: 'relative', zIndex: '1', backgroundColor: '#e7eae8', padding: '15px' }}>
