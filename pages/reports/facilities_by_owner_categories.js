...
const FacilitiesByOwnersCategories = (props) => {
    ...
    let label ='facilities_owner_categories'
...
FacilitiesByOwnersCategories.getInitialProps = async (ctx) => {
...
export default FacilitiesByOwnersCategories
