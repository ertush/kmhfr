			...
			<MainLayout isLoading={false} searchTerm={props?.query?.searchTerm}>
				<div className="w-full grid grid-cols-5 h-full mb-12 gap-4">
					<div className="col-span-5 flex flex-col gap-3 md:gap-5 mb-4">
						...
						<div className={"col-span-5 flex justify-between w-full  border border-green-600  text-black p-4 md:divide-x md:divide-gray-200z items-center border-l-8 " + (true ? "border-green-600" : "border-red-600")}>
					...
					{/* Stepper and Form */}
					<div className='col-span-4 md:col-start-2 md:col-span-4 flex flex-col items-center border border-green-600  pb-4 pt-8 gap-4 mt-3 order-last md:order-none'>
						{/* Stepper Header */}
						...
						<div className='flex flex-col justify-center items-start px-1 md:px-4 w-full '>
							<div
								className=' w-full flex flex-col items-start justify-start p-3  border border-gray-300/70 '
								...
								{(() => {
									switch (parseInt(formId)) {
										case 0:
											...
											return (
												<>
													<h4 className='text-lg uppercase pb-2 w-full mb-4 font-semibold text-green-900'>
												...
												<>
													...
													<form ref={facilityRegulationFormRef} name="facility_regulation_form" className='flex flex-col w-full items-start bg-yellow-50 shadow-md p-4 justify-start gap-3' onSubmit={ev => handleRegulationSubmit(ev, [setFormId, facilityId, facilityOfficialName, facilityRegulationFormRef], licenseFile)}>
														...
														<div className='w-full flex justify-end items-center mt-2'>
															...
															<button onClick={(e) => {
																e.preventDefault(); setFacilityDepts(s => {
																	return [
																		...s, {
