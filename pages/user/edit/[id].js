...
function User(props) {
  ...
  const handleOnChange = (val) => {
    if (val.target && val.target != undefined && val.target != null) {
      ...
      newObj2[val.name] = {};
      val.name == "job_title"
        ? (newObj2[val.name] = val.ev.value)
        : (newObj2[val.name] = val.ev.map((id) => {
            return { id: id.value, name: id.label };
          }));
      ...
      val.cont_name == "contact_type"
        ? (data[val.id][val.cont_name] = val.value.value)
        : (data[val.id][val.cont_name] = val.value.target.value);
      console.log(data);
  ...
  async function handleBasicDetailsSubmit(event, token) {
    ...
    url = editMode
      ? `${process.env.NEXT_PUBLIC_API_URL}/users/${person_details.id}/`
  ...
  useEffect(() => {
        ...
        Object.keys(userData).map((ud) => {
          if (ud === pd) {
            ...
            if (pd == "user_counties") {
              newObj_i[pd] = [
                {
                  id: person_details[`${pd}`][0]?.county,
                  name: person_details[`${pd}`][0]?.county_name,
                },
              ];
    ...
    if (
      person_details.contacts !== null &&
      person_details.contacts !== undefined &&
      person_details.contacts !== ""
    ) {
      ...
      <MainLayout isLoading={false} searchTerm={props?.query?.searchTerm}>
              ...
              >
                <div className="flex gap-2">
                  ...
                  <span className="flex gap-2">
                    Are you sure you want to deactivate user account for
                    <b>
                      {userData?.first_name +
                        " " +
                        userData?.last_name +
                ...
                <div className="flex justify-start gap-4 mt-4">
                  <button
                    className="bg-red-400 text-white font-semibold rounded p-2 text-center"
                    type="button"
                    disabled={!delete_user}
                    onClick={(e) => {
                      deleteUser(e, props?.token);
                      setOpen(false);
                    }}
                  >
                    {submitting ? (
                  ...
                  <button
                    className="bg-gray-500 text-white font-semibold rounded  p-2 text-center"
                    onClick={() => {
                      setOpen(false);
                    }}
                  >
        ...
        <div className="w-full  md:w-[85%] md:mx-auto grid grid-cols-5 gap-4 px-1 md:px-4 py-2 my-4">
          <div className="col-span-5 flex flex-col gap-3 md:gap-5 px-4">
            <div className="flex flex-wrap items-center justify-between gap-2 text-sm md:text-base pb-3">
              <div className="flex flex-row items-center justify-between gap-2 text-sm md:text-base py-3">
                ...
                <Link className="text-gray-500" href="/user">
                  Users
                </Link>
                {"/"}
            ...
            <div
              className={
                "col-span-5 flex bg-transparent items-center border border-gray-600 justify-between p-6 w-full drop-shadow  text-black mb-3 md:divide-x md:divide-gray-200 border-l-8 " +
            ...
            >
              <h2 className="flex items-center text-xl font-bold text-black capitalize gap-2">
                {editMode ? (
                  <>
                    <PencilAltIcon className="ml-2 h-5 w-5" /> Edit user
                  </>
                ) : (
                  <>
                    <UserAddIcon className="text-black ml-2 h-5 w-5" /> Add
                    user{" "}
                  </>
                )}
              </h2>
          ...
          <div className="col-span-5 flex flex-col justify-center items-start px-1 md:px-4 w-full ">
            <div
              className=" w-full flex flex-col bg-gray-50 items-start p-3  border shadow-md"
                ...
                >
                            ...
                            <div className="w-full flex flex-col items-left gap-1 gap-x-3 mb-3">
                              ...
                              <Select
                                ...
                                defaultValue={{
                                  ...
                                  label: contact_types.find(
                                    (ct) =>
                                      ct.value ==
                                      userData?.contacts[i]?.contact_type,
                                  )?.label,
                                }}
                                name="contact_type"
                                className="flex-none w-full  flex-grow  placeholder-gray-500 border border-gray-600 outline-none"
                        ...
                        {(() => {
                          if (grp.id == 1 || grp.id == 12 || grp.id == 2) {
                            return (
                              ...
                              <div
                                key={i}
                                className=" w-full flex flex-col items-start justify-start py-3   bg-transparent h-auto"
                              >
                                <h4 className="text-lg uppercase pb-2 border-b border-gray-600 w-full mb-4 font-semibold text-gray-900">
                                ...
                                <div className="w-full flex flex-row items-center gap-1 gap-x-3 mb-3">
                                  <div className="w-full flex flex-col items-left  gap-2 gap-x-3 mb-3">
                                    <Select
                                        ...
                                        for (let i = 0; i < ev.length; i++) {
                                          try {
                                            const resp = await fetch(
                                              `/api/filters/subcounty/?county=${ev[i].value}${"&fields=id,name,county&page_size=30"}`,
                                            );
                                      ...
                                      defaultValue={userData.user_counties?.map(
                                        (value) => ({
                                          value: value.county,
                                          label:
                                            value.county_name || value.name,
                                        }),
                                      )}
                                      name="county"
                                      className="flex-none w-full  flex-grow  placeholder-gray-500 border border-gray-600 outline-none"
                                    ...
                                    {grp.id !== 1 && (
                                      <Select
                                        ...
                                        onChange={(ev) => {
                                          handleOnChange({
                                            name: "user_sub_counties",
                                            ev,
                                          });
                                        }}
                                        defaultValue={userData.user_sub_counties?.map(
                                          (value) => ({
                                            value: value.id,
                                            label:
                                              value.sub_county_name ||
                                              value.name,
                                          }),
                                        )}
                                        name="sub_county"
                                ...
                                <div className="w-full flex flex-row items-center px-2 justify-  gap-1 gap-x-3 mb-3">
                                  <div className="w-full flex flex-col items-left px-2 justify-  gap-1 gap-x-3 mb-3">
                                    <Select
                                      ...
                                      onChange={(ev) => {
                                        handleOnChange({
                                          name: "regulatory_users",
                                          ev,
                                        });
                                      }}
                                      defaultValue={userData.regulatory_users?.map(
                                        (value) => ({
                                          value: value.id,
                                          label: value.name,
                                        }),
                  ...
                  <div className="flex justify-between items-center w-full">
                    <button
                      ...
                      className="flex items-center justify-start space-x-2 p-1 border-2 border-black  px-2"
                    >
            ...
            switch (option) {
              case "groups":
                ...
                try {
                  ...
                  allOptions["groups"] = (await _data.json()).results.map(
                    ({ id, name }) => {
              ...
              case "contact_type":
                ...
                try {
                  ...
                  allOptions["contact_type"] = (await _data.json()).results.map(
                    ({ id, name }) => {
                      return { value: id, label: name };
                    },
                  );
              ...
              case "counties":
                ...
                try {
                  ...
                  allOptions["counties"] = (await _data.json()).results.map(
                    ({ id, name }) => {
                      return { value: id, label: name };
                    },
                  );
              ...
              case "job_titles":
                ...
                try {
                  ...
                  allOptions["job_titles"] = (await _data.json()).results.map(
                    ({ id, name }) => {
                      return { value: id, label: name };
                    },
                  );
