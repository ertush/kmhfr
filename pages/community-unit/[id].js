            ...
            <MainLayout>
                <div className="w-full grid grid-cols-5 gap-4 p-2 my-6">
                        ...
                        <div className={"col-span-5 grid grid-cols-6 gap-5 md:gap-8 py-6 w-full bg-gray-50 drop-shadow rounded text-black p-4 md:divide-x md:divide-gray-200z items-center border-l-8 " + (cu.active ? "border-green-600" : "border-red-600")}>
                            <div className="col-span-6 md:col-span-3">
                                ...
                                <div className="flex gap-2 items-center w-full justify-between">
                                    ...
                                    <p className="text-gray-600 leading-tight">{cu.keph_level_name && "KEPH " + cu.keph_level_name}</p>
                                </div>
                            </div>
                            ...
                            <Tabs.Panel value="overview" className="grow-1 py-1 px-4 tab-panel">
                                <div className="col-span-4 md:col-span-4 flex flex-col gap-y-2 group items-center justify-start text-left">
                                    ...
                                    <div className="bg-white border border-gray-100 w-full p-3 rounded flex flex-col gap-3 shadow-sm mt-4">
                                        ...
                                        {cu.officer_in_charge && <div className="grid grid-cols-3 w-full md:w-11/12 mx-auto leading-none items-center">
                                            <label className="col-span-1 text-gray-600 capitalize">{cu.officer_in_charge.title_name || "Officer in charge"}</label>
                                            <p className="col-span-2 text-black font-medium text-base">{cu.officer_in_charge.name || " - "}</p>
                                        </div>}
                                        {cu.officer_in_charge && (cu.officer_in_charge.contacts.length > 0) && cu.officer_in_charge.contacts.map(contact => (
                    ...
                    <aside className="flex flex-col col-span-5 md:col-span-2 gap-4 mt-5">
                        ...
                        {(cu?.lat_long && cu?.lat_long.length > 0) ? <div className="w-full bg-gray-200 shadow rounded-lg flex flex-col items-center justify-center relative">
                            <Map operational={cu.status_name} code={cu?.code || "NO_CODE"} lat={cu?.lat_long[0]} long={cu?.lat_long[1]} name={cu.official_name || cu.name || ""} />
                        </div> :
                        ...
                        <div className="flex flex-col gap-2 mt-3">
                            ...
                            <ol className="list-decimal list-outside ml-4 flex flex-row gap-3">
                                <li className="bg-gray-50 w-full rounded-sm p-2">
                                    {cu?.latest_approval_or_rejection?.comment && <p>{cu?.latest_approval_or_rejection?.comment}</p>}
