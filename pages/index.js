        ...
        <>
          ...
          <div className="w-full h-screen overflow-y-scroll flex flex-col">
            ...
            <div className='w-[60%] mx-auto flex mt-8'>
             ...
             <div className="w-[60%] mx-auto mt-12 h-auto  flex items-center flex-wrap gap-5 justify-center">
                

                <Link href="https://healthit.uonbi.ac.ke">
                  <Image className="cursor-pointer" src="/healthit.png" alt="HealthIT" objectFit='contain' width="400" height="100" />
                </Link>
                ...
                <Link href="https://health.go.ke">
                  <Image className="cursor-pointer" src="/moh-logo.png" alt="Ministry Of Health" objectFit='contain' width="400" height="100" />
                </Link>
