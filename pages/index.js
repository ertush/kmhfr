  ...
  if (isClient) {
    ...
    <header className='w-full max-h-min block'>
        ...
        <div className="w-full h-screen overflow-y-scroll flex flex-col items-center md:items-start">
          ...
          {/* Menu Heading */}
          <div className='w-full bg-gray-300 top-[90px] md:top-[95px] fixed z-10 max-h-min flex items-center justify-between md:items-start md:items-between p-3 md:p-0'>
          ...
          <div className='w-full mb-8 '>
            <div className='w-full mt-[145px] md:mt-[160px] md:h-[300px] h-[550px] p-6  flex flex-col items-center justify-center gap-y-6' style={{
          ...
          <div className="md:w-[80%] w-full md:mx-auto flex justify-center md:justify-between flex-wrap gap-8 h-auto mt-6">
            ...
            <div class="p-4 w-[250px] h-[150px] rounded flex flex-col bg-gray-300/45 shadow-sm ">
          ...
          <div class="md:w-[80%] w-full md:mx-auto flex justify-center md:justify-between flex-wrap gap-8 h-auto mt-6">
          ...
          <div className="md:w-[80%] w-full md:mx-auto flex justify-center md:justify-between flex-wrap gap-8 h-auto mt-6">
            ...
            <Link href="https://healthit.uonbi.ac.ke">
              <Image className="cursor-pointer" src="/healthit.png" alt="HealthIT" objectFit='contain' width="250" height="70" />
            </Link>
