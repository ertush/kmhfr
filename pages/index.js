                ...
                <MainLayout isLoading={false} searchTerm={props?.query?.searchTerm}>
                    <div className="w-full grid grid-cols-2 gap-6 px-3 md:px-4 p-4 my-4 max-w-screen-lg mx-auto">
                        ...
                        <div className="col-span-2 md:col-span-1 border rounded-lg border-gray-300 shadow group hover:bg-gray-50 focus:bg-gray-50 active:bg-gray-50 p-4 flex flex-col items-center justify-start">
                            ...
                            <p className="text-base">
                                You can learn all about KHMFL, its implementation and how to use it here (<a className="text-blue-800 hover:underline focus:underline active:underline" target="_blank" rel="noopener noreferrer" href="https://elearning.health.go.ke">https://elearning.health.go.ke</a>). Enrol and start learning.
                            </p>
                        </div>
                    </div>
                </MainLayout>
