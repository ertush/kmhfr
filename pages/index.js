              ...
              <Head>
                  ...
                  <MainLayout isLoading={false} searchTerm={props?.query?.searchTerm}>
                      <div className="w-full grid grid-cols-2 gap-6 px-3 md:px-4 p-4 my-4 max-w-screen-lg mx-auto">
                          ...
                          <div className="col-span-2 md:col-span-1 hover:border bg-blue-50 shadow-sm ease-in-out delay-150 hover:border-blue-600 group hover:bg-blue-600 hover:text-gray-50 focus:bg-gray-50 active:bg-gray-50 p-4 flex flex-col items-center justify-start">
