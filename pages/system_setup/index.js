...
function SystemSetup(props) {
                        ...
                        switch (resourceCategory) {
                                ...
                                switch (resource) {
                                    ...
                                    case 'wards':
                                        setColumns([
                                            { field: 'name', label: 'Name', flex: 2 },
                                            { field: 'code', label: 'Code', flex: 2 },
                                            { field: 'sub_county_name', label: 'Sub-county', flex: 2 },
                                            { field: 'constituency_name', label: 'Constituency', flex: 2 },
                                            { field: 'county_name', label: 'County', flex: 2 },
                                            {
                            ...
                            case 'HealthInfrastructure':
                                if (resource === 'infrastructure') {
                                    setColumns([
                                        { field: 'name', label: 'Name', flex: 2 },
                                        { field: 'category_name', label: 'Category', flex: 2 },
                                        { field: 'numbers', label: 'Tracking numbers?', flex: 2, format: 'boolean' },
                                        {
                                            field: 'action', label: 'Action', flex: 1, renderCell: (params) => (
                            ...
                            case 'Facilities':
                                switch (resource) {
                                    ...
                                    case 'facility_types':
                                        ...
                                        switch (addBtnLabel) {
                                            ...
                                            case 'facility type detail':
                                                setColumns([
                                                    { field: 'name', label: 'Facility Type', flex: 2 },
                                                    {
                                                        field: 'action', label: 'Action', flex: 1, renderCell: (params) => (
                                            ...
                                            case 'facility type category':
                                                setColumns([
                                                    { field: 'name', label: 'Facility Type Details', flex: 2 },
                                                    { field: 'sub_division', label: 'Facility Type', flex: 2 },
                                                    {
                                                        field: 'action', label: 'Action', flex: 1, renderCell: (params) => (
                                    ...
                                    case 'facility_status':
                                        setColumns([
                                            { field: 'name', label: 'Facility Status', flex: 2 },
                                            { field: 'is_public_visible', label: 'Public Visible', flex: 2 },
                                            {
                                                field: 'action', label: 'Action', flex: 1, renderCell: (params) => (
                                    ...
                                    case 'facility_admission_status':
                                        setColumns([
                                            { field: 'name', label: 'Facility Admission Status', flex: 2 },
                                            {
                                                field: 'action', label: 'Action', flex: 1, renderCell: (params) => (
                                    ...
                                    case 'facility_service_ratings':
                                        setColumns([
                                            { field: 'facility_name', label: 'Facility', flex: 2 },
                                            { field: 'service_name', label: 'Service', flex: 2 },
                                            { field: 'comment', label: 'Comment', flex: 2 },
                                            { field: 'rating', label: 'Rating', flex: 2 },
                                    ...
                                    case 'owners':
                                        ...
                                        setColumns([
                                            { field: 'code', label: 'Code', flex: 2 },
                                            { field: 'name', label: 'Name', flex: 2 },
                                            { field: 'abbreviation', label: 'Abbreviation', flex: 2 },
                                            { field: 'owner_type_name', label: 'Owner Type', flex: 2 },
                                            {
                                                field: 'action', label: 'Action', flex: 1, renderCell: (params) => (
                                    ...
                                    case 'level_change_reasons':
                                        ...
                                        setColumns([
                                            { field: 'reason', label: 'Change Reason', flex: 2 },
                                            {
                            ...
                            case 'CHU':
                                setColumns([
                                    { field: 'facility_name', label: 'Facility', flex: 2 },
                                    { field: 'chu_name', label: 'CHU', flex: 2 },
                                    { field: 'comment', label: 'Comment', flex: 2 },
                                    { field: 'rating', label: 'Rating', flex: 2 },
                                    {
                            ...
                            case 'Documents':
                                ...
                                setColumns([
                                    { field: 'name', label: 'Name', flex: 2 },
                                    { field: 'description', label: 'Description', flex: 2 },
                                    { field: 'fyl', label: 'Link', flex: 2, link: true },
                                    {
                                        field: 'action', label: 'Action', flex: 1, renderCell: (params) => (
    ...
    async function fetchSbctyConstituency(id) {
