	...
	return (
		<div className=''>
			...
			<MainLayout isLoading={false} searchTerm={props?.query?.searchTerm}>
				<div className='w-full md:w-[85%] md:mx-auto grid grid-cols-1 md:grid-cols-5 gap-4 py-2 px-4 md:px-0 my-4'>
				...
				<div className='w-full md:w-[85%] md:mx-auto grid grid-cols-1 md:grid-cols-5 gap-3 mb-12 place-content-start px-4 md:px-0 border-gray-300'>
						{/* Side Menu Filters*/}
