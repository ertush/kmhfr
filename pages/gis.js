        ...
        <>
              ...
              <div className="w-full grid grid-cols-6 gap-5 px-1 md:px-4 p-4 mx-auto bg-gray-100 min-h-screen">
                <aside className="col-span-6 md:col-span-2 lg:col-span-2 xl:col-span-1 p-1 md:p-2 flex flex-col lg:gap-3 items-center justify-start bg-white rounded-lg shadow">
                  ...
                  >
                        ...
                        <div className="bg-white w-full p-3 rounded">
                          {props?.data && props?.data?.results && (
                            <h4 className="text-base md:text-xl tracking-tight font-bold leading-tight">
                              {props?.data?.results?.length} facilities found.
                            </h4>
                          )}
                        </div>
                        <hr className="my-2" />
                                ...
                                {filters &&
                                  ...
                                  Object.keys(fltrs).map((ft) => (
                                    ...
                                    >
                                      ...
                                      <Select
                                        isMulti={f_multiFilters.includes(ft)}
                                        name={ft}
                                ...
                                <div className="w-full flex flex-row items-center px-2 justify-between gap-1 gap-x-3 mb-3">
                                  ...
                                  <span className="flex items-center gap-x-1">
                                    <input
                                      ...
                                      value={true}
                                      defaultChecked={
                                        props?.query?.number_of_beds === "true"
                                      }
                                      name="number_of_beds"
                                      id="number_of_beds"
                                      onChange={(ev) => {
                                  ...
                                  <span className="flex items-center gap-x-1">
                                    <input
                                      ...
                                      value={false}
                                      defaultChecked={
                                        props?.query?.number_of_beds === "false"
                                      }
                                      name="number_of_beds"
                                      id="number_of_beds"
                                      onChange={(ev) => {
                                ...
                                <div className="w-full flex flex-row items-center px-2 justify-between gap-1 gap-x-3 mb-3">
                                  ...
                                  <span className="flex items-center gap-x-1">
                                    <input
                                      ...
                                      value={true}
                                      defaultChecked={
                                        props?.query?.number_of_cots === "true"
                                      }
                                      name="number_of_cots"
                                      id="number_of_cots"
                                      onChange={(ev) => {
                                  ...
                                  <span className="flex items-center gap-x-1">
                                    <input
                                      ...
                                      value={false}
                                      defaultChecked={
                                        props?.query?.number_of_cots === "false"
                                      }
                                      name="number_of_cots"
                                      id="number_of_cots"
                                      onChange={(ev) => {
                                ...
                                <div className="w-full flex flex-row items-center px-2 justify-between gap-1 gap-x-3 mb-3">
                                  ...
                                  <span className="flex items-center gap-x-1">
                                    <input
                                      ...
                                      value={true}
                                      defaultChecked={
                                        props?.query?.open_whole_day === "true"
                                      }
                                      name="open_whole_day"
                                      id="open_whole_day"
                                      onChange={(ev) => {
                                  ...
                                  <span className="flex items-center gap-x-1">
                                    <input
                                      ...
                                      value={false}
                                      defaultChecked={
                                        props?.query?.open_whole_day === "false"
                                      }
                                      name="open_whole_day"
                                      id="open_whole_day"
                                      onChange={(ev) => {
                                ...
                                <div className="w-full flex flex-row items-center px-2 justify-between gap-1 gap-x-3 mb-3">
                                  ...
                                  <span className="flex items-center gap-x-1">
                                    <input
                                      ...
                                      value={true}
                                      defaultChecked={
                                        props?.query?.open_weekends === "true"
                                      }
                                      name="open_weekends"
                                      id="open_weekends"
                                      onChange={(ev) => {
                                  ...
                                  <span className="flex items-center gap-x-1">
                                    <input
                                      ...
                                      value={false}
                                      defaultChecked={
                                        props?.query?.open_weekends === "false"
                                      }
                                      name="open_weekends"
                                      id="open_weekends"
                                      onChange={(ev) => {
                                ...
                                <div className="w-full flex flex-row items-center px-2 justify-between gap-1 gap-x-3 mb-3">
                                  ...
                                  <span className="flex items-center gap-x-1">
                                    <input
                                      ...
                                      value={true}
                                      defaultChecked={
                                        props?.query?.open_public_holidays ===
                                        "true"
                                      }
                    ...
                    <Tabs.Panel
                      value="cunits"
                      className="grow-1 py-1 px-1 sm:px-2 lg:px-2 tab-panel"
                    >
                      <div className="col-span-4 md:col-span-4 flex flex-col group items-center justify-start text-left">
                        <div className="bg-white w-full p-2 rounded">
                          <div className="bg-white w-full py-2 rounded">
                            {props?.data && props?.data?.results && (
                              <h4 className="text-base md:text-xl tracking-tight font-bold leading-tight">
                                {props?.data?.results?.length} community units
                                found.
                              </h4>
                            )}
                          </div>
                          <hr className="my-2" />
                          <details
                            className="rounded bg-transparent py-1 gap-y-2 flex flex-col w-full md:stickyz"
                            open
                          >
                            <summary className="flex cursor-pointer w-full bg-white p-0">
                              <h5 className="text-xl font-semibold">Filters</h5>
                                  ...
                                  {filters &&
                                    ...
                                    Object.keys(filters).map((ft) => (
                                      ...
                                      >
                                        ...
                                        <Select
                                          isMulti={c_multiFilters.includes(ft)}
                                          name={ft}
                                          defaultValue={props?.query[ft] || ""}
                                          id={ft}
                                          className="w-full p-1 rounded bg-gray-50"
          ...
          <div className="fixed bottom-4 right-5 z-10 w-96 h-auto bg-yellow-50/60 bg-blend-lighten shadow-lg rounded-lg flex flex-col justify-center items-center py-2 px-3">
            ...
            <p className="text-sm text-gray-800">
              For testing reasons, the facilities/CUs are limited to the first
              600 results.
            </p>
          </div>
          {/* ))))))) */}
